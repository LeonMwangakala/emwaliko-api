...
class EventController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'name_text_color' => 'nullable|string|regex:/^#[0-9A-Fa-f]{6}$/',
            'card_class_text_color' => 'nullable|string|regex:/^#[0-9A-Fa-f]{6}$/',
            'name_text_size' => 'nullable|integer|min:12|max:200',
            'card_class_text_size' => 'nullable|integer|min:12|max:200',
        ...
        $eventData = [
            ...
            'name_position_x' => $validated['name_position_x'] ?? null,
            'name_position_y' => $validated['name_position_y'] ?? null,
            'qr_position_x' => $validated['qr_position_x'] ?? null,
            'qr_position_y' => $validated['qr_position_y'] ?? null,
            'card_class_position_x' => $validated['card_class_position_x'] ?? null,
            'card_class_position_y' => $validated['card_class_position_y'] ?? null,
            'name_text_color' => $validated['name_text_color'] ?? null,
            'card_class_text_color' => $validated['card_class_text_color'] ?? null,
            'name_text_size' => $validated['name_text_size'] ?? null,
            'card_class_text_size' => $validated['card_class_text_size'] ?? null,
