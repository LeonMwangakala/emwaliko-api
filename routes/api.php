...
Route::post('events/{event}/guests/generate-all-cards', [GuestController::class, 'generateAllMissingCards']);
Route::delete('guests/{guest}/card', [GuestController::class, 'deleteGuestCard']);
